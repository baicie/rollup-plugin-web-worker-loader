...
export function createBase64WorkerFactory(
    ...
    const enableUnicode = enableUnicodeArg === undefined ? false : enableUnicodeArg;
    ...
    return function WorkerFactory(options?: object): Worker | null {
        ...
        return new WorkerClass(body, { ...options, eval: true } as ConstructorParameters<typeof WorkerClass>[1]);
    };
}
