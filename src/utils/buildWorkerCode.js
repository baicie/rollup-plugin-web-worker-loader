...
export function getFactoryFuncName(options) {
...
export function getArgsString(source, sourcemap, options) {
  if (options.targetPlatform === 'base64') {
    return Buffer.from(
      source,
      options.enableUnicode ? 'utf16le' : 'utf8',
    ).toString('base64')
  }
...
export function buildWorkerSource(options, factoryFuncName, argsString) {
  if (options.targetPlatform === 'base64') {
    return `
/* eslint-disable */
