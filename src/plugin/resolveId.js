...
export function resolveModule(name, paths, extensions) {
  const testNames = [
    name,
...
export function getMatchAndType(importee, config) {
...
export function resolveId(state, config, importee, importer) {
